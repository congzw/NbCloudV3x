...
namespace ZQNB.Common.Themes.Web.Mvc
{
    public class ThemeViewEngine : RazorViewEngine
    {
        ...
        {
            return TryGetTheme(controllerContext);
        }
        ...
        private static string DefaultThemeParamNameOrConfigKey = "Theme";
        ...
        private static string TryGetTheme(ControllerContext controllerContext)
        {
            var themeManager = ThemeManagerRegistry.Instance.GetService();
            if (themeManager == null)
            {
                //default impl =>  read from requsest or config
