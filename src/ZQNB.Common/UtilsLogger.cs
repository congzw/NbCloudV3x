...
namespace ZQNB.Common
{
    ...
    public class UtilsLogger
    {
        ...
        private static string GetPrefix()
        {
            ...
            string prefixSeed = "[NbV3x][ZQNB][UtilsLogger]";
            string preFix = MyConfigHelper.GetAppSettingValue(Config_Common_LogPrefix, "NbV3x");
            if (!string.IsNullOrWhiteSpace(preFix))
            {
                prefixSeed = prefixSeed.Replace("NbV3x", preFix);
